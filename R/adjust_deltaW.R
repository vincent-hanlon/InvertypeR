...
save(WW_reads, WC_reads, WW_d, WC_d, inversions, genotype, file="adjust.RData")
	...
	#And then some annoying checks and formatting in case the wide intervals overlap 0 reads, because the pair2frgm step (now galignments_to_granges) removes a few
