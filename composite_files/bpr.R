...
chromosomes=chr,windowsize=as.integer(args[1]),binMethod="size", minReads=as.integer(args[2]), background=0.2,maskRegions=paste0(args[7],"blacklist.highdepth.centromeres.bed"))
dev.off()
