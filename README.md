...
To install invertyper, run `devtools::install_github("vincent-hanlon/InvertypeR/invertyper")`. You might need to install [devtools](https://cran.r-project.org/web/packages/devtools/index.html) first, if you don't already have it. (still troubleshooting package installation).
